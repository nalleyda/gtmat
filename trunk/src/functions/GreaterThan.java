...
public class GreaterThan {
	public static MatObject greaterThan(MatObject o1, MatObject o2) throws Exception{
		return (MatObject)GreaterThan.class.getMethod("greaterThan", o1.getClass(), o2.getClass()).invoke(null, new Object[] {o1, o2});
	}
